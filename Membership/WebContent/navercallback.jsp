...
<body>
	<%
		String clientId = "rLsBEDtTSbbefDD_ApaW";//애플리케이션 클라이언트 아이디값";
		String clientSecret = "om6jIwX2q4";//애플리케이션 클라이언트 시크릿값";
		...
		out.println("사용자 Email = " + email +"<br>"); 
		*/
	%>
</body>
</html>
<%!
	...
	private String getAccessToken(String myurl) throws Exception{
			...
			BufferedReader br;
			if (responseCode == 200) { //상태코드 정상 호출
			...
			br.close();
			if (responseCode == 200) {
				//System.out.println(res.toString()); //응답예시[JSON]
			}
			return res.toString();
		} 
%>
<%!
	private String getResult(String token)throws Exception{
		...
		String str = "Bearer " + access_token; //주의 : 반드시 Bearer  뒤에 한칸 띄울 것
