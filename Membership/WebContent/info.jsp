...
<body>
	...
	<form action="/Membership/update.jsp" method="post" name="myform">
		<ul>
			...
			<li>Address : <input type="text" name="address1" readonly="readonly" value ="${member.getAddress1() }"size="50"></li>
			<li>Address1 : <input type="text" name="address2" value="${member.getAddress2() }"></li>
			<li><button type="submit"  class="btn btn-info btn-sm">수정하기</button>&nbsp;&nbsp;
				<button type="reset" class="btn btn-success btn-sm">다시하기</button>&nbsp;&nbsp;
				<button type="button" id="btnHome" class="btn btn-primary btn-sm">홈으로</button></li>
		</ul>
	</form>
	</div>
</body>
