...
<%
	Date now = new Date();
	DateFormat longFormat = DateFormat.getDateInstance(DateFormat.LONG ,Locale.GERMAN);
	DateFormat shortFormat = DateFormat.getDateInstance(DateFormat.SHORT, Locale.ITALY);
